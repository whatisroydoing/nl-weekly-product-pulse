...
4. **History:** It lets users view their last 3 generated pulse reports.

> **Note:** The Fee Explainer (Module F) is **email-only** — it is not displayed in the frontend UI or the PDF export. The fee section is appended to the HTML email body when sending reports.
